...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `Especialidad` (`id`, `especialidad`, `habilitado`) VALUES (DEFAULT, 'PEDIATRA', NULL);
INSERT INTO `Especialidad` (`id`, `especialidad`, `habilitado`) VALUES (DEFAULT, 'MEDICO GENERAL', NULL);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `TipoTel` (`id`, `tipo`) VALUES (DEFAULT, 'RESIDENCIAL');
INSERT INTO `TipoTel` (`id`, `tipo`) VALUES (DEFAULT, 'CELULAR');
INSERT INTO `TipoTel` (`id`, `tipo`) VALUES (DEFAULT, 'FAX');
INSERT INTO `TipoTel` (`id`, `tipo`) VALUES (DEFAULT, 'TRABAJO');
INSERT INTO `TipoTel` (`id`, `tipo`) VALUES (DEFAULT, 'EMERGENCIA');
INSERT INTO `TipoTel` (`id`, `tipo`) VALUES (DEFAULT, 'RESPONSABLE');
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `Estadocivil` (`id`, `estadocivil`) VALUES (DEFAULT, 'SOLTERO (A)');
INSERT INTO `Estadocivil` (`id`, `estadocivil`) VALUES (DEFAULT, 'CASADO (A)');
INSERT INTO `Estadocivil` (`id`, `estadocivil`) VALUES (DEFAULT, 'DIVORCIADO (A)');
INSERT INTO `Estadocivil` (`id`, `estadocivil`) VALUES (DEFAULT, 'SEPARADO (A)');
INSERT INTO `Estadocivil` (`id`, `estadocivil`) VALUES (DEFAULT, 'VIUDO (A)');
INSERT INTO `Estadocivil` (`id`, `estadocivil`) VALUES (DEFAULT, 'UNIDO (A)');
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `Escolaridad` (`id`, `escolaridad`, `habilitado`) VALUES (DEFAULT, 'Ninguno', true);
INSERT INTO `Escolaridad` (`id`, `escolaridad`, `habilitado`) VALUES (DEFAULT, 'Primaria', true);
INSERT INTO `Escolaridad` (`id`, `escolaridad`, `habilitado`) VALUES (DEFAULT, 'Básico', true);
INSERT INTO `Escolaridad` (`id`, `escolaridad`, `habilitado`) VALUES (DEFAULT, 'Diversificado', true);
INSERT INTO `Escolaridad` (`id`, `escolaridad`, `habilitado`) VALUES (DEFAULT, 'Universitario', true);
INSERT INTO `Escolaridad` (`id`, `escolaridad`, `habilitado`) VALUES (DEFAULT, 'Ignorado', true);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `Tipoegreso` (`id`, `tipoegreso`, `habilitado`) VALUES (DEFAULT, 'VIVO', NULL);
INSERT INTO `Tipoegreso` (`id`, `tipoegreso`, `habilitado`) VALUES (DEFAULT, 'MUERTO', NULL);
INSERT INTO `Tipoegreso` (`id`, `tipoegreso`, `habilitado`) VALUES (DEFAULT, 'CONTRA INDICACION', NULL);
INSERT INTO `Tipoegreso` (`id`, `tipoegreso`, `habilitado`) VALUES (DEFAULT, 'ANTES DE 48 hrs', NULL);
INSERT INTO `Tipoegreso` (`id`, `tipoegreso`, `habilitado`) VALUES (DEFAULT, 'TRANSFERIDO A OTRA INSTITUCION', NULL);
INSERT INTO `Tipoegreso` (`id`, `tipoegreso`, `habilitado`) VALUES (DEFAULT, 'REFERDIO A', NULL);
INSERT INTO `Tipoegreso` (`id`, `tipoegreso`, `habilitado`) VALUES (DEFAULT, 'DESPUES DE 48 hrs', NULL);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `Servicio` (`id`, `servicio`, `habilitado`) VALUES (DEFAULT, 'MEDICINA', NULL);
INSERT INTO `Servicio` (`id`, `servicio`, `habilitado`) VALUES (DEFAULT, 'CIRUGÍA', NULL);
INSERT INTO `Servicio` (`id`, `servicio`, `habilitado`) VALUES (DEFAULT, 'OBSTETRÍCIA', NULL);
INSERT INTO `Servicio` (`id`, `servicio`, `habilitado`) VALUES (DEFAULT, 'PEDIATRÍA', NULL);
INSERT INTO `Servicio` (`id`, `servicio`, `habilitado`) VALUES (DEFAULT, 'TRAUMATOLOGÍA', NULL);
INSERT INTO `Servicio` (`id`, `servicio`, `habilitado`) VALUES (DEFAULT, 'UCI', NULL);
